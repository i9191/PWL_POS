    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            @empty($kategori)
                ...
                <a href="{{ url('barang/kategori') }}" class="btn btn-sm btn-default mt-2">Kembali</a>
            @else
                <form method="POST" action="{{ url('barang/kategori/' . $kategori->kategori_id) }}" class="form-horizontal">
                    @csrf
                    {!! method_field('PUT') !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            ...
                            <a class="btn btn-sm btn-default ml-1" href="{{ url('barang/kategori') }}">Kembali</a>
                        </div>
                    </div>
                </form>
            @endempty
