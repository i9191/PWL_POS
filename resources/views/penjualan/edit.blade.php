                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <div class="input-group">
                                    <input type="text" class="form-control datepicker pl-3" data-provide="datepicker" id="penjualan_tanggal" name="penjualan_tanggal" value="{{ $transaction->penjualan_tanggal }}" required>
...
<script>
    $(document).ready(function(){
        ...
        $(".datepicker").datepicker("setDate", new Date('{{$transaction->penjualan_tanggal}}'));
